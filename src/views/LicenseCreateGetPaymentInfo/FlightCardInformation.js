...
import { formatPhoneNumber, getRoostedEmail, getRoostedData } from '../../utils/utilities'
...
function CardInformation(
  ...
  const handleSubmit = async (event) => {
    ...
    try{
              ...
              updateUser, {
                input: {
                  ...
                  roostedAgent: 
                  {
                    ...
                    stripeState: license.licenseState,
                  }
                }
              }
            ))
      ...
      let toEmail = getRoostedEmail(license.licenseState, 'flock') 
      ...
      fromEmail = getRoostedEmail(license.licenseState, 'support') 
      toEmail = globalUser.email
      toFullName = `${globalUser.userFirstName} ${globalUser.userLastName}`

      let roostedData = getRoostedData(license.licenseState)
