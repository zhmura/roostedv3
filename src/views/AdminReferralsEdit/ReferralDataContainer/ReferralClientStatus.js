        ...
        let custom1 = { 
          ...
          body: {
            emailData: {
              ...
              toFullName: referral.referralPartnetAgent.userFirstName + ' ' + referral.referralPartnetAgent.userLastName,
              fromEmail: fromEmail,
              partnerAgentFirstName: referral.referralPartnetAgent.userFirstName,
              w9Link: getW9Link(referral.referralReferringAgentState)
            }
          }
        }
        console.log(custom1)
        const sendGridResponse1 = await API.post(
          'roostedRestAPI', 
          '/sendgrid/send-email',
          custom1
        )
        console.log(sendGridResponse1)
        //SENDGRID EMAIL TEMPLATE/////
      }
      ...
      let custom = { 
        ...
        body: {
          emailData: {
            ...
            partnerAgentFirstName: 'Roosted',
            partnerAgentLastName: 'Admin',
            status: getClientStatusStepsObject(formDataCollected.clientStatus),
            referralLink: `https://app.roosted.io/referrals/details/roosted/${referral.id}/referraldata?id=${referral.referralRoostedAgent.id}/referraldata`
          }
        }
      }
      console.log(custom)
