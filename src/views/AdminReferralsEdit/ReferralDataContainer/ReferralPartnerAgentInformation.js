...
function ReferralPartnerAgentInformation({ className, dataCollected, setDataCollected, referral, globalUser, userSetUser, ...rest }) {
  ...
  return (
    ...
    >
      ...
      <CardHeader classes={{title: classes.header}} title="Partner Agent Information" className={classes.header} />
      <Divider />
      ...
      <CardActions className={classes.actions}>
        <div style={{alignSelf: 'center'}}>
          <Button
            ...
            disabled={referral.referralPartnerAgent === undefined || referral.referralPartnerAgent === null}
          >
            Edit Partner Agent
          </Button>
        </div>
