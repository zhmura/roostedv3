...
import ModalEditPartnerAgent from './ModalEditPartnerAgent'
...
function ReferralPartnerAgentInformation({ className, dataCollected, setDataCollected, referral, globalUser, userSetUser, ...rest }) {
  ...
  return (
    ...
    >
      ...
      <CardHeader classes={{title: classes.header}} title="Referred Agent Information" className={classes.header} />
      <Divider />
          ...
          <Table size='small'>
            <TableBody>
              <TableRow>
                ...
                <TableCell>
                  {referral.referralPartnerAgent !== undefined && referral.referralPartnerAgent !== null ?
                    `${referral.referralPartnerAgent.userFirstName} ${referral.referralPartnerAgent.userLastName}` : ''}
                </TableCell>
              </TableRow>
              <TableRow selected>
                <TableCell><b>Email</b></TableCell>
                <TableCell>{referral.referralPartnerAgent !== undefined && referral.referralPartnerAgent !== null  ? referral.referralPartnerAgent.email : ''}
              ...
              <TableRow >
                ...
                <TableCell>{referral.referralPartnerAgent !== undefined && referral.referralPartnerAgent !== null ? formatPhoneNumber(referral.referralPartnerAgent.userPhone) : ''}
      ...
      <CardActions className={classes.actions}>
        <div style={{alignSelf: 'center'}}>
          <Button
            ...
            disabled={(referral.referralStatus === 'accepted' || referral.referralStatus === 'closed' || referral.referralStatus === 'clientLost') ||  (referral.referralPartnerAgent === undefined || referral.referralPartnerAgent === null)}
...
ReferralPartnerAgentInformation.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ReferralPartnerAgentInformation);
