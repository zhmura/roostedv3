...
import { getTimeFrames, getPriceRanges, getStatesByAgentType, agentShareByPlan, estimatePayout, getRoostedEmail } from '../../../utils/utilities'
...
function ModalEditReferralDataSeller({
  ...
  const onSubmit = async (formDataCollected) => {
    ...
    try {
      ...
      setDataCollected.setErrorMessage("An error occurred. Please try again or contact support@roosted.io.")
...
export default connect(mapStateToProps, mapDispatchToProps)(ModalEditReferralDataSeller);
