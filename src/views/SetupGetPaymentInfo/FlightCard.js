...
import CardInformation from './FlightCardInformation'
      ...
      <CardHeader
        ...
        subheader={(
          <Typography variant="body2">
            90/10 Commission Share With Roosted
          </Typography>
        )}
        title={<Typography variant='h5'>Flight Plan</Typography>}
      />
      <Divider style={{marginTop: '0.5rem'}}/>
      <CardContent className={classes.content}>
        <div align='center' className={classes.description}>
          <Typography variant="h6" gutterBottom>Great for 5+ referrals per year</Typography>
          <Typography variant="h6" gutterBottom>Keep 90% of the referral commission</Typography>
        </div>
        ...
        <div className={classes.details}>
          ...
          >
            ...
            <Grid item align='center' xs={12}>
              <Button
                variant={planSelected === 'flight' ? 'contained' : 'outlined'}
                size="small"
                color='primary'
                onClick={() => setPlanSelected('flight')}
              >
                {planSelected === 'flight' ? 'Selected Plan' : 'Select Plan'}
              </Button>
              </Grid>
          </Grid>
        </div>
