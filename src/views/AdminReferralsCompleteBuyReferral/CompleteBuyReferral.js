          ...
          >
            ...
            >
              <Controller
                ...
                id="priorAgent"
                name="priorAgent"
                helperText={partnerAgentArray.length === 0 ? 'You have no partner agents to select from.' : ''}
                control={control}
                defaultValue={partnerAgentArray.length === 0 ? 'No Prior Agents' : 'Select Agent'}//filteredReferrals[0].referralPartnerAgentID}
                ...
                as={<TextField 
                      ...
                      {partnerAgentArray.map(agent => (
                        ...
                        >
                          {agent !== null && agent !== undefined ? agent.licenseUser.userFirstName + ' ' + agent.licenseUser.userLastName : ''}
                        </option>
                      ))}
                    </TextField>}
                />
