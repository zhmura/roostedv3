...
function ModalEditPartnerAgent({
  ...
  const onSubmit = async (formDataCollected) => {
    ...
    try {
      ...
      setDataCollected.setErrorMessage("Failed to change agent. Please try again or contact support@roosted.io.")
                  ...
                  <Controller
                    ...
                    as={<TextField 
                          ...
                          {filteredReferrals.map(referral => (
                            <option
                              key={referral.referralPartnerAgentID}
                              value={referral.referralPartnerAgentID}
                            >
