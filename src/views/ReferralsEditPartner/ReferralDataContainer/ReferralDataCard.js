      ...
      >
        ...
        <div style={{alignSelf: 'center'}}>
          <Button startIcon={<EditIcon/>} onClick={() => handleEditOpen(referral.referralType)} 
                  disabled={(referral.referralStatus === 'rejected' || referral.referralStatus === 'closed' || referral.referralStatus === 'clientLost')}>
        ...
        <Table size='small'>
          ...
          <TableRow>
            ...
            <TableRow selected>
              ...
              `${referral.referralAddress.street} ${referral.referralAddress.unit === null || referral.referralAddress.unit === undefined ? '' : referral.referralAddress.unit}` : ''}
              </TableCell>
            </TableRow>
            <TableRow >
