          ...
          <Table size='small'>
            <TableBody>
              <TableRow>
                ...
                <TableCell>
                  {referral.referralClient !== undefined ? referral.referralStatus !== 'accepted' ? 'Accept Referral To Reveal' :
                    `${referral.referralClient.clientFirstName} ${referral.referralClient.clientLastName}` : ''}
                </TableCell>
              </TableRow>
              <TableRow selected>
                <TableCell><b>Email</b></TableCell>
                <TableCell>{referral.referralClient !== undefined  ? referral.referralStatus !== 'accepted' ? 'Accept Referral To Reveal' : referral.referralClient.clientReferralEmail : ''}
              ...
              <TableRow >
                ...
                <TableCell>{referral.referralClient !== undefined ? referral.referralStatus !== 'accepted' ? 'Accept Referral To Reveal' : formatPhoneNumber(referral.referralClient.clientPhone) : ''}
              ...
              <TableRow >
                ...
                <TableCell>{referral.referralComments !== undefined && referral.referralComments !== null ? referral.referralComments : 'None'}
                {/* type === 'partner' && (referral.referralStatus === 'accepted' || referral.referralStatus === 'closed' || referral.referralStatus === 'clientLost') ? formatPhoneNumber(client.customerPhone) : 'Accept the Referral to Reveal' : ''} */}
                </TableCell>
              </TableRow>
            </TableBody>
